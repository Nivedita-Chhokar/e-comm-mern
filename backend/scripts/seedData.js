...
const products = [
  {
    ...
    description:
      'Quiet and energy-efficient cooling fan with 3 speed settings and oscillation feature. Perfect for bedrooms and small spaces.',
    price: 59.99,
    category: 'fan',
    imageURLs: [
  ...
  },
  {
    ...
    description:
      'Powerful tower fan with 5 speed settings and wide oscillation range. Features a sleek design and quiet operation.',
    price: 89.99,
    category: 'fan',
    imageURLs: [
  ...
  },
  {
    ...
    description:
      'Elegant ceiling fan with wooden blades and built-in LED lighting. Features reversible blades for year-round use.',
    price: 129.99,
    category: 'fan',
    imageURLs: [
  ...
  },
  {
    ...
    description:
      'Efficient window air conditioner with digital controls and eco mode. Perfect for cooling small to medium rooms.',
    price: 249.99,
  ...
  },
  {
    ...
    description:
      'High-performance split air conditioner with inverter technology for energy efficiency. Features smart connectivity and allergen filter.',
    price: 499.99,
    category: 'air_conditioner',
    imageURLs: [
